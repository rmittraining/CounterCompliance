...
<xsl:stylesheet version="1.0" xmlns:xsl="http://www.w3.org/1999/XSL/Transform" xmlns:tlb="tlb:tlb">
  ...
  <xsl:template match="/">
    <html>
      <head>
        <title>Journal Report 5 (R4)</title>
        ...
        <div class="container-fluid">
          ...
          <div class="panel panel-info">
            ...
            <div class="panel-heading">
              <div class="panel-title col-md-3">Journal Report 5 (R4)</div>
              <div class="panel-title">Number of Successful Full-text Article Requests by Year-of-Publication (YOP) and Journal </div>
            </div>
        ...
        the same publisher/vendor. If not, this cell is left blank.-->
              ...
              <xsl:for-each select="ReportData/Item">
                <tr>
                  ...
                  <!--fulltext count based on Yop for individual journal-->
                  <xsl:for-each select="//YearlySummary">
